...
void main() {
  ...
  setUp(() async {
    ...
    await SettingsService.saveKidProfile(const KidProfile(age: 5, grade: KidGrade.kindergarten));
  });

  group('Drawer & Navigation Tests', () {
    testWidgets('Hamburger menu opens drawer with Kid Profile and Support options', (WidgetTester tester) async {
      ...
      expect(find.text('WORKSHEET MODULES'), findsOneWidget);
      expect(find.text('Support LearnLoop'), findsOneWidget);
    });

    testWidgets('Drawer allows changing Kid Profile globally', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1600);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
      ...
      expect(SettingsService.currentKidProfile.grade, equals(KidGrade.kindergarten));
    });
  });

  group('Handwriting Screen UI Refinements Tests', () {
    testWidgets('KidProfileCard is not in HandwritingScreen customize panel', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1600);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
    ...
    testWidgets('Left margin checkbox option is removed from HandwritingScreen', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1600);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
      ...
      expect(find.text('Show Left Vertical Margin Guide (Red Line)'), findsNothing);
    });

    testWidgets('Line Style Selector expands on click and allows selecting a style', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1600);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
      ...
      expect(find.text('Select Line Style (Large Visual Preview):'), findsNothing);
      ...
      expect(find.text('Select Line Style (Large Visual Preview):'), findsOneWidget);
    ...
    testWidgets('Line color scheme is a segmented toggle (Color & Black/White)', (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1200, 1600);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
      ...
      final segmentedFinder = find.byType(SegmentedButton<GuidelineColorScheme>);
      ...
      final SegmentedButton<GuidelineColorScheme> widget = tester.widget(segmentedFinder);
      expect(widget.selected, contains(GuidelineColorScheme.monochrome));
    });

    testWidgets('Dotted font switch is only shown when Tracing mode is selected', (WidgetTester tester) async {
  ...
  group('Page Margin Dropdown Tests', () {
    testWidgets('PageMarginDropdown displays standard presets', (WidgetTester tester) async {
